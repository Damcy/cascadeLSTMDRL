...
class BinaryHeap(object):
    ...
    def report(self):
        if self.size > 10:
            # top 10 record
            print('top 10 prioritized replay:')
            for i in range(1, 11):
                print('rank %d, priority %f' % (i, self.priority_queue[i][0]))
            # last 10 record
            print('last 10 prioritized replay:')
    ...
    def _insert(self, priority, e_id):
        ...
        # print('binary heap insert index: ', self.size)
