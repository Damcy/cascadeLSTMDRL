...
class ReplayMemory:
    ...
    def __init__(self, conf):
        self.size = conf['replay_memory_size']
        ...
        self.total_steps = conf['max_step'] if 'max_step' in conf else 100000
    ...
    def sample(self, global_step):
        ...
        if self.record_size < self.learn_start:
            sys.stderr.write('Record size : %d \n' % self.record_size)
            sys.stderr.write('learn start: %d \n' % self.learn_start)
